    ...
    <div className="max-w-full  bg-white rounded-lg shadow-lg p-6 mt-8">
      <form action="https://6ammart-admin.6amtech.com/admin/campaign/basic/update/6" method="post" id="campaign-form" encType="multipart/form-data">
        ...
        <div className="mt-6 flex justify-end">
          ...
          <button type="submit" className="py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#24bac3] hover:bg-[#20A7AF] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Submit</button>
        </div>
      </form>
    </div>
