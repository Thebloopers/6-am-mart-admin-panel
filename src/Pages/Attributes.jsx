...
import { createAttribute, getAdminAttributes } from "../helpers/attributes";
...
function Attributes() {
  ...
  // Add Unit
  const addUnitMutation = useMutation(createAttribute, {
    onSuccess: (data) => {
      setIsLoading(false);
  ...
  const handleCreateAttribute = (event) => {
  ...
  return (
    <>
      <div className="page-header flex ">
        <h1 className="page-header-title flex items-center">
          <span className="page-header-icon">
            <img
              src="https://6ammart-admin.6amtech.com/public/assets/admin/img/attribute.png"
              className="w-26"
              alt=""
            />
          </span>
          <span className="ml-2 text-xl font-semibold">Add new attribute</span>
        </h1>
      </div>
      ...
      <div className="card-body bg-white rounded-md shadow-md p-6 mt-5">
        <form onSubmit={handleCreateAttribute}>
          <div className="flex flex-col">
            <label htmlFor="attribute-name" className="mb-2 text-gray-700">
              Attribute *
            </label>
            <input
              type="text"
      ...
      <div className="mt-8">
        ...
        {/*Delete This Component <AttributeListTable /> */}
