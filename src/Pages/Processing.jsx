     ...
     <h1 className="page-header-title capitalize m-0 flex text-2xl gap-3 font-extrabold">
      ...
      <div>
          <div className="md:flex  items-center justify-between md:gap-3 mt-4 border  ">
            ...
            <div class="card-header  border-b-0 mr-3 mx-2 mb-2 md:flex md:flex-wrap md:items-center md:justify-between">
              ...
              <div class="flex items-center   ">
                <div className="relative ">
                  ...
                  >
                    <span className="dropdown-header text-nowrap bg-gray-200 text-gray-700 py-2 px-3 rounded-t-lg">
                      Download options
                    </span>
                    <Link
