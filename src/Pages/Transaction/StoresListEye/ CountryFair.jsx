    ...
    <div>
      <div>
        <h1 className="font-bold text-2xl flex items-center mb-4">
          ...
          <span className="align-middle">{storeData?.storeName}</span>
        </h1>
        <div>
              ...
              <div className="md:flex md:justify-between">
                <div className="">
                  <ul className="md:flex flex-wrap md:space-x-4 md:m-2 text-md font-light">
                    <li
                      className={`p-2 hover:text-[#24bac3] cursor-pointer ${
                        value === "1"
                          ? "text-[#24bac3] rounded-lg  border-b-[6px] border-[#24bac3] "
                          : ""
                      }`}
                    ...
                    <div className="col-md-3 ">
                      <div className="card h-full bg-[#eafbff] border border-gray-200 hover:border-gray-300 transition duration-300">
                        <div className="card-body text-center flex flex-col justify-center items-center">
                          ...
                          <div className="flex items-center justify-center mt-3">
                            <div className="cash-icon mr-3">
                              <img
                                src="https://6ammart-admin.6amtech.com/public/assets/admin/img/cash.png"
                                alt="img"
                                className="w-10"
                              />
                            </div>
                        ...
                        <div className="card-footer bg-[#334257] pt-0  border-0">
                          <button
                            className="text-xl font-bold text-white hover:bg-gray-500  capitalize bg-title h-12 w-full"
                            id="collect_cash"
                            type="button"
                            data-toggle="modal"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 ">
                        <div className="col-sm-6 ">
                          <div className="resturant-card pl-5 rounded-md p-2  bg-[#fff7e7] border border-gray-300 hover:border-gray-200 transition duration-300">
                            <h4 className="font-semibold text-[#feb019] text-xl ">
                              $ 0.00
                            </h4>
                            <p className="font-semibold">Pending withdraw</p>
                            <img
                              className="resturant-icon w-10"
                              src="https://6ammart-admin.6amtech.com/public/assets/admin/img/transactions/pending.png"
                              alt="transaction"
                            />
                          </div>
                        </div>
                        ...
                        <div className="col-sm-6">
                          <div className="resturant-card bg--title pl-5 bg-[#eafdf6]  rounded-md p-2 border border-gray-300 hover:border-gray-200 transition duration-300">
                            <h4 className="font-semibold text-[#00aa6d] text-xl ">
                              $ 0.00
                            </h4>
                            ...
                            <img
                              className="resturant-icon w-10"
                              src="https://6ammart-admin.6amtech.com/public/assets/admin/img/transactions/withdraw-amount.png"
                              alt="transaction"
                            />
                          </div>
                        </div>
                        ...
                        <div className="col-sm-6">
                          <div className="resturant-card bg--title pl-5 rounded-md p-2 bg-[#fff2f2] border border-gray-200 hover:border-gray-500 transition duration-300">
                            <h4 className="font-semibold text-[#ff6d6d] text-xl">
                              $ 0.00
                            </h4>
                            <div className="subtitle font-semibold">
                            ...
                            <img
                              className="resturant-icon w-10"
                              src="https://6ammart-admin.6amtech.com/public/assets/admin/img/transactions/withdraw-balance.png"
                              alt="transaction"
                            />
                          </div>
                        </div>
                        ...
                        <div className="col-sm-6">
                          <div className="resturant-card  border pl-5 rounded-md bg-[#eafbff] p-2 border-gray-200 hover:border-gray-300 transition duration-300">
                            <h4 className="font-semibold text-[#16abcb] text-xl">
                              $ 0.00
                            </h4>
                            <div className="subtitle font-semibold">
                              Total earning
                            ...
                            <img
                              className="resturant-icon w-10"
                              src="https://6ammart-admin.6amtech.com/public/assets/admin/img/transactions/earning.png"
                              alt="transaction"
                            />
                          </div>
                        </div>
                      ...
                      <div className="md:flex md:justify-between ">
                        <div className="flex">
                          <div className="logo mr-4">
                            <img
                              ...
                              src={`https://rent-karoo.s3.ap-south-1.amazonaws.com/${storeData?.storeLogo[0]}`}
                              alt="Country Fair Logo"
                              onError={(e) => {
                                e.target.onerror = null;
                                e.target.src =
                                  "https://6ammart-admin.6amtech.com/public/assets/admin/img/100x100/1.png";
                              }}
                            />
                          </div>
                          <div className="address-info">
                            <ul className="list-none py-3 text-dark">
                              <li className="flex  mb-2">
                                <i className="tio-city nav-icon mr-2">
                                  {" "}
                                  <FaCity />
                                </i>
                                <span className="font-semibold">Address</span>:
                                {storeData?.completeAddress}
                              </li>
                              <li className="flex items-center mb-2">
                                <i className="tio-call-talking nav-icon mr-2">
                                  <MdOutlineEmail />
                                </i>
                                <span className="font-semibold">Email</span>:{" "}
                                <a href="">{storeData?.email}</a>
                              </li>
                              <li className="flex items-center mb-2">
                                <i className="tio-email nav-icon mr-2">
                                  <FaPhoneVolume />{" "}
                                </i>
                                <span className="font-semibold">Phone</span>:
                                <a href="tel:020000000015">
                                  {" "}
                                  {storeData?.phone}
                                </a>
                              </li>
                        ...
                        <div className="">
                          <iframe
                            ...
                            }&center=${storeData?.location?.coordinates[0]},${
                    ...
                    <div className="address-info">
                      <ul className="list-none py-3 text-dark">
                        ...
                        <li className="flex items-center mb-2">
                          ...
                          <span className="font-semibold">Phone</span>:{" "}
                          <a href="tel:020000000015">{storeData?.phone}</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="resturant-card-navbar md:flex md:justify-between  items-center border border-gray-100 rounded-md p-4">
                    <div className="order-info-item flex items-center mr-3 m-2 border-r-2  pr-6 ">
                      <div className="order-info-icon mr-2  ">
                        <img
                          src="https://6ammart-admin.6amtech.com/public/assets/admin/img/navbar/all.png"
                          alt="All Orders"
                        />
                      </div>
                      <h6 className="card-subtitle mb-0 font-bold">
                        All
                        <span className="amount  text-[#3182ce] ml-1">1</span>
                      </h6>
                    </div>
                    <div className="order-info-item flex m-3 border-r-2  pr-6">
                      <div className="order-info-icon mr-2">
                        <img
                          src="https://6ammart-admin.6amtech.com/public/assets/admin/img/navbar/schedule.png"
                          alt="Scheduled Orders"
                        />
                      </div>
                      <h6 className="card-subtitle mb-0 font-bold">
                        Scheduled
                        <span className="amount  text-[#FFA500] ml-1">0</span>
                      </h6>
                    </div>
                    <div className="order-info-item flex items-center m-3 border-r-2  pr-6   mr-4">
                      <div className="order-info-icon mr-2">
                        <img
                          src="https://6ammart-admin.6amtech.com/public/assets/admin/img/navbar/pending.png"
                          alt="Pending Orders"
                        />
                      </div>
                      <h6 className="card-subtitle mb-0 font-bold">
                        Pending
                        <span className="amount text-[#3498db] ml-1">1</span>
                      </h6>
                    </div>
                    <div className="order-info-item flex items-center m-3 mr-4 border-r-2  pr-6">
                      <div className="order-info-icon mr-2">
                        <img
                          src="https://6ammart-admin.6amtech.com/public/assets/admin/img/navbar/delivered.png"
                          alt="Delivered Orders"
                        />
                      </div>
                      <h6 className="card-subtitle mb-0 font-bold">
                        Delivered
                        <span className="amount text-[#28a745] ml-1">0</span>
                      </h6>
                    </div>
                    <div className="order-info-item flex items-center m-3">
                      <div className="order-info-icon mr-2">
                        <img
                          src="https://6ammart-admin.6amtech.com/public/assets/admin/img/navbar/cancel.png"
                          alt="Canceled Orders"
                        />
                      </div>
                      <h6 className="card-subtitle mb-0 font-bold">
                    ...
                    <div className="flex items-center space-x-4 ml-5 mt-2 mr-2">
                      <div className="relative">
                        ...
                        >
                          ...
                          Export
                          <span className="ml-2">{/* <MdExpandMore /> */}</span>
                        </button>
                  ...
                  <div className="resturant-card-navbar md:flex md:justify-between   md:items-center   rounded-md mt-5 pb-3">
                    <div className="order-info-item flex items-center justify-between rounded bg-gray-100 w-full  border px-2 py-3">
                      <div className="order-info-icon  flex gap-2  ">
                        <img
                          src="https://6ammart-admin.6amtech.com/public/assets/admin/img/store_items/fi_9752284.png"
                          alt="All Orders"
                        />
                        <h6 className=" font-bold">All Items </h6>
                      </div>
                      <div>
                        <span className="amount  text-[#3182ce] font-bold text-xl ml-1">
                          1
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="order-info-item flex items-center justify-between rounded bg-gray-100 w-full m-2  border px-2 py-3 ">
                      <div className="order-info-icon  flex gap-2  ">
                        <img
                          src="https://6ammart-admin.6amtech.com/public/assets/admin/img/store_items/fi_10608883.png"
                          alt="All Orders"
                        />
                    ...
                    <div className="order-info-item flex items-center justify-between rounded bg-gray-100 w-full px-2 border py-3    ">
                      <div className="order-info-icon  flex gap-2  ">
                        <img
                          src="https://6ammart-admin.6amtech.com/public/assets/admin/img/store_items/fi_10186054.png"
                          alt="All Orders"
                        />
                        <h6 className="card-subtitle mb-0 font-bold">
                          Inactive Items{" "}
                    ...
                    <div className="order-info-item flex items-center justify-between rounded bg-gray-100 w-full m-2 px-2  border py-3    ">
                      <div className="order-info-icon mr-2 flex gap-2  ">
                        <img
                          src="https://6ammart-admin.6amtech.com/public/assets/admin/img/store_items/fi_5106700.png"
                          alt="All Orders"
                        />
                        <h6 className="card-subtitle mb-0 font-bold">
                          Pending Approval{" "}
                    ...
                    <div className="order-info-item flex items-center justify-between rounded bg-gray-100 w-full  px-2  border py-3   ">
                      <div className="order-info-icon mr-1 flex gap-2  ">
                        <img
                          src="https://6ammart-admin.6amtech.com/public/assets/admin/img/store_items/image 89.png"
                          alt="All Orders"
                        />
